jsx.require(['Location', 'Cookies'], function(){
    ...
    var filter = jsx.Location.getParam('jsxdebug') || jsx.Cookies.getCookie('jsxdebug') || jsx.DebugMode || 'off';
    if (filter == 'off'){
        jsx.Cookies.delCookie('jsxdebug');
        jsx.loaded('Debug');
        return;
    }

    jsx.Cookies.setCookie('jsxdebug', filter);
